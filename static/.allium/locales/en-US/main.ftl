...
settings-power-cpu-clock = CPU Clock
settings-power-cpu-clock-stock = Stock (1.2 GHz)
settings-power-cpu-clock-1296 = 1.3 GHz
settings-power-cpu-clock-1488 = 1.5 GHz
...
settings-power-desc-cpu-clock-stock = The clock the device ships with. Takes effect at the next game launch.
settings-power-desc-cpu-clock-overclock = Games run faster, warmer, and for less time per charge. Stability is not guaranteed.
