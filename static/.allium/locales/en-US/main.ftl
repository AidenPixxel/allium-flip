...
settings-power-charging-boot-action = When Plugged In While Off
settings-power-charging-boot-action-charge-screen = Show Charging Screen
...
settings-power-performance-mode = Default Performance Mode
settings-power-performance-mode-system = System
settings-power-performance-mode-battery = Battery
settings-power-performance-mode-balanced = Balanced
settings-power-performance-mode-performance = Performance

settings-power-desc-performance-system = Leaves the CPU speed alone. Set a mode per game from the in-game menu.
settings-power-desc-performance-battery = Locks the CPU to its slowest speed. Saves power, but too slow for GBA.
settings-power-desc-performance-balanced = Speeds the CPU up only when a game needs it.
settings-power-desc-performance-performance = Holds the CPU at full speed. Smoothest, and uses the most battery.
...
ingame-menu-performance = Performance
ingame-menu-performance-default = Default
ingame-menu-performance-battery = Battery
ingame-menu-performance-balanced = Balanced
ingame-menu-performance-performance = Performance
